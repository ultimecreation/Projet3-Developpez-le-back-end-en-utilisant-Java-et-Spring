...
public class OpenApiConfig {
    ...
    public OpenAPI baseOpenAPI() {
        ...
        // UNAUTHORIZED
        ApiResponse unauthorizedRequestApi = new ApiResponse().content(
        ...
        ApiResponse authSuccessRequestApi = new ApiResponse().content(
                new Content().addMediaType(MediaType.APPLICATION_JSON_VALUE,
                        new io.swagger.v3.oas.models.media.MediaType().addExamples("default",
                                new Example().value("{\"token\": \"some jwt token\"}"))))
                .description("Success");
        ...
        ApiResponse messageSuccessRequestApi = new ApiResponse().content(
                new Content().addMediaType(MediaType.APPLICATION_JSON_VALUE,
                        new io.swagger.v3.oas.models.media.MediaType().addExamples("default",
                                new Example().value("{\"message\": \"Message send with success\"}"))))
                .description("Success");
